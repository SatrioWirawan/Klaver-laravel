...
<div class="card">
    ...
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="/images/{{$value->foto}}" alt=""></td>
                <td>Rp.{{$value->harga}}</td>
                <td>
                    <button type="button" id="" class="btn btn-outline-secondary border-1 p-1">
                        <a class="" href="/product/{{$value->id}}" style="color: black;">
                            <span class="far fa-file-alt"></span>
                            show
                        </a>
                    </button>
                    <button type="button" id="" class="btn btn-outline-secondary border-1 p-1">
                        <a class="" href="/product/{{$value->id}}/edit" style="color: black;">
      ...
      <a href="/product/create" class="btn btn-primary m-2">Add</a>
    </div>
    <!-- /.card-body -->
